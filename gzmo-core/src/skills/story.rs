...
use super::generative::{
    ...
    quality_gate_story, require_gateway,
};
...
impl Skill for StorySkill {
    ...
    async fn execute(&self, ctx: SkillContext<'_>) -> Result<SkillOutput> {
        ...
        let mut recent_themes =
            themes_from_fingerprints(&recent_openings, "story openings");
...
mod tests {
    ...
    fn test_story_quality_gate() {
        ...
        assert!(quality_gate_story("The oil was cold. The metal did not turn."));
    }
}
