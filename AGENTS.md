...
**USP:** full living Keep on one airgapped box — [docs/ADR-0004-airgap-living-usp.md](docs/ADR-0004-airgap-living-usp.md). Quality: `bash scripts/keep-quality-gate.sh`. Lite MCP (`~/.gzmo`) is bootstrap only.
