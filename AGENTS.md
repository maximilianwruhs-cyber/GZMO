...
**Architecture authority:** [docs/ADR-INDEX.md](docs/ADR-INDEX.md) · constitution [docs/ADR-0011-self-developing-living-database.md](docs/ADR-0011-self-developing-living-database.md). Historical (superseded) USP notes: [ADR-0004](docs/ADR-0004-airgap-living-usp.md) / [ADR-0007](docs/ADR-0007-one-product-living.md) — retained only as lineage under ADR-0011.
