...
echo "  echo 'durable fact' > \"\$(herdr plugin config-dir gzmo.metabolism)/takeaway.txt\""
echo "  herdr plugin action invoke gzmo.metabolism.session-close"
echo "Optional: \$(herdr plugin config-dir gzmo.metabolism)/env"
