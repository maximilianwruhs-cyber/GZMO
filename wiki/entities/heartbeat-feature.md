...
- A proactive mechanism in OpenClaw.
- Allows the agent to wake up on a schedule.
- Used to check inboxes, monitor systems, or send reminders without human intervention.
