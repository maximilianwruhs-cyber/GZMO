...
- The second tier of JavaScriptCore's JIT architecture.
- Provides light optimization for warm code paths.
...
- Provides light optimization for frequently executed code paths.
