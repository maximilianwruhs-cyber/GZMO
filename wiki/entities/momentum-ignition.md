...
- Manipulative strategy that can be inadvertently executed by algorithms.
...
- A manipulative strategy that algorithms can inadvertently execute.
...
- A type of manipulative strategy that algorithms can inadvertently execute.
