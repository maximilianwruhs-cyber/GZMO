...
- Creates a 'blended space' where a solution is solved using mechanics, metaphors, and logic of unrelated domains.
- Identifies structural similarities and hidden rules of each domain.
