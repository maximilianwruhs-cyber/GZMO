---
type: entity
title: beowolx/CodeNinja-1.0-OpenChat-7B
created: 2026-06-08
updated: 2026-06-08
sources: 3
tags: []
...
- Scores poorly on general benchmarks (50.35 average) but its capabilities are preserved in Beyonder-4x7B-v3.
- It is a specialized Mistral-7B checkpoint.
- It is a coding expert.
- It exhibits lower performance on general-purpose benchmarks, averaging 50.35% on the Nous suite.
- It is one of the four specialized 7B models consolidated in mlabonne/Beyonder-4x7B-v3.
- Its primary synthesis role is "Syntactic generation and structural coding."
- It scores poorly on general-purpose benchmarks, averaging only 50.35%.
...
- Associated with 'code' and 'python' positive prompts.
