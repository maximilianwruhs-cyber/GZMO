---
type: entity
title: mlabonne/Beyonder-4x7B-v3
created: 2026-06-08
updated: 2026-06-08
sources: 4
tags: []
...
- It is a prominent community model.
- It fuses four specialized Mistral-7B checkpoints.
- It shows significant improvements over its predecessor (v2) across all benchmarks.
- A case study for the performance of upcycled Mixtures of Experts.
- Assembled using LazyMergekit.
- It is a community-compiled model used as an informative benchmark for upcycled Mixture of Experts configurations.
