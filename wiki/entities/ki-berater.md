...
- Tritt als 'Gewissen' des Projekts auf.
- Muss Projektrisiken eskalieren, wenn ethische Standards nicht erfüllt werden.
- Moderiert Konflikte zwischen Abteilungen.
- Führt Best-Practice-Ansätze ein.
- Stellt sicher, dass die Diskussion auf Business Value fokussiert bleibt.
- Erstellt Use Case Worksheets.
- Gibt strategische Empfehlungen für Pilotprojekte.
- Modifiziert Detailfragen basierend auf der Industrie des Kunden.
- Sucht primär nach Potenzialen zur Senkung von R&D-Kosten in der Pharmaindustrie.
- Fokussiert sich im Automotive-Sektor auf anspruchsvolle Technologien.
- Fokussiert sich im Finanzwesen und Einzelhandel auf Datensicherheit, Erklärbarkeit und Hyperautomatisierung.
- Hat sich vom Technologie-Erklärer zum transformativen Chefarchitekten entwickelt.
