...
- An MCP server that gives agents the ability to scrape the web.
...
- A community-built local MCP server.
- Gives Roo Code local web-scraping powers.
...
- An MCP server that provides local web-scraping powers.
- Allows Roo Code to fetch library documentation.
