...
- Integrates with Kuadrant's AuthPolicy for rule evaluation.
...
- Used in production for MCP tool access governance.
- Enforces authorization via JWT validation and OPA rules.
