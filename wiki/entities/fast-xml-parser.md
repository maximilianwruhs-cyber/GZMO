...
- Modern parser.
- No C/C++ dependencies.
- Allows users to validate XML, parse it into JS objects, and build XML payloads rapidly.
- Versions later than 5.3.3 must be used due to a documented RangeError vulnerability in earlier iterations.
