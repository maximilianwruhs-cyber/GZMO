...
- It is a technique to employ for the migration of mission-critical functionality.
- It involves placing a proxy or interface in front of old code.
- It allows maintaining both old and new implementations simultaneously behind a layer.
