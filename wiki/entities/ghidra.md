...
- Has a Ghidra MCP Server operating on a split architecture.
...
- Has a Ghidra MCP Server consisting of a Java plugin and a Python MCP bridge.
- The Ghidra MCP Server can run in a headless Docker mode.
...
- A complex tool integrated with language models via MCP.
- Has an MCP Server operating on a split architecture.
- The Ghidra MCP Server can run in a headless Docker mode.
