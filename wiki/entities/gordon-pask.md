...
- He is associated with the formal Teachback method.
- His work ensures shared meaning is actively constructed and continuously verified.
- Provided the formal, dialectical framework for mapping how information loops between two observing, cognitive entities.
- Posited that two asynchronous cognitive systems can establish shared meaning only through a highly structured, iterative feedback loop.
