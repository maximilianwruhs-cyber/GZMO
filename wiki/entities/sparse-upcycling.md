...
- A technique where a dense model is duplicated into a sparse MoE structure.
- Used to initialize continued pre-training.
- Bypasses initial stages of training a sparse architecture from scratch.
