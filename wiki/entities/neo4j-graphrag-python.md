...
- Leverages Neo4j, Qdrant, and Redis for its memory layer.
- Provides the neo4j-graphrag-python library.
- The neo4j-graphrag-python library includes the QdrantNeo4jRetriever class.
