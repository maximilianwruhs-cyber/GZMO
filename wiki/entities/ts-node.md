...
- Bun natively executes TypeScript, replacing the need for tools like ts-node.
...
- Bun's internal transpiler replaces the need for ts-node for execution.
...
- Bun replaces the need for ts-node.
