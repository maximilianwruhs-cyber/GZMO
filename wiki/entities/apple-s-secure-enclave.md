...
- Relying on host-specific hardware cryptographic mechanisms—such as Apple's Secure Enclave—violates the strict cross-platform portability requirement.
