...
- Enables undisturbed, lossless 'Shared Gradient-based Credit Assignment'.
- Error gradient is propagated through the system using Backpropagation Through Time (BPTT).
