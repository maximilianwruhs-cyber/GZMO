...
- Roughly 2 to 3 times faster than other modern parsers like fast-xml-parser.
- Achieves performance by traversing the XML string rapidly and constructing a lightweight structure.
- Lack of strict validation capabilities.
- MIT license.
