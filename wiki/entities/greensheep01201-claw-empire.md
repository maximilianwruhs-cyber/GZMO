---
type: entity
title: GreenSheep01201/claw-empire
created: 2026-06-08
updated: 2026-06-09
sources: 3
tags: []
...
- Enables human operators to visually orchestrate and monitor complex agent collaborations.
- Agents can call its REST API to create tasks and work within isolated git worktrees.
- Renders the 'black box' of multi-agent orchestration transparent and intuitive.
- Agents can call this API to create tasks.
- Allows agents to work within isolated git worktrees.
- It is a repository.
