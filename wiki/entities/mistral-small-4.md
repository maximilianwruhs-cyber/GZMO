...
- Can process large context windows with KV cache quantization
...
- Leverages Mistral AI's focus on extreme operational efficiency and hardware optimization.
- Features a context window of 256K tokens.
- Provides native image input support.
- Achieves a staggering throughput of 206.3 tokens per second.
- Has an exceptionally low TTFT of just 459 milliseconds.
- Is priced at $0.15 per 1M input tokens and $0.60 per 1M output tokens.
