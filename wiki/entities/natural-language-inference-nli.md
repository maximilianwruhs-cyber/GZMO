...
- A strict classification task.
- Requires rigorously comparing a hypothesis against a premise.
- Outputs one of three exact strings: 'Supported', 'Contradicted', or 'No Information'.
