...
- Interpolates along a spherical vector path.
- Maintains a constant weight magnitude and preserves high-dimensional geometric properties.
- Used for blending two distinct models (e.g., instruct and chat fine-tune) without magnitude degradation.
