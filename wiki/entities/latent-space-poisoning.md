...
- The deepest layers of the latent space hold invariant truth.
- Vector activations within the latent space can be analyzed to identify deceptive thought signatures.
- An attack where an adversary injects malicious data into the training set.
...
- Creates insidious backdoors or 'sleeper agents'.
- Persists even through rigorous safety training.
