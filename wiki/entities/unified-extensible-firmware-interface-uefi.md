...
- Many early implementations had critical logic bugs.
- Can technically boot an operating system residing on an MBR-partitioned disk.
- The technology industry is definitively moving toward a unified standard with GPT.
