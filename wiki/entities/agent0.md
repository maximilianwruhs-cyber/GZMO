...
- Unleashes Self-Evolving Agents from Zero Data via Tool-Integrated Reasoning.
- Shows consistent improvement for both Qwen3-4B and Qwen3-8B across three co-evolutionary iterations.
- Significantly outperforms other tool-using baselines like Absolute Zero and non-tool methods like R-Zero and SPIRAL.
- Described as "Unleashing Self-Evolving Agents from Zero Data via Tool-Integrated Reasoning".
...
- Improved mathematical reasoning by 18% and general reasoning by 24% autonomously.
