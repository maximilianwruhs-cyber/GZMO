...
- Introduced proprietary, internally trained AI systems.
- Developed and uses the internal AI 'Lilli'.
...
- Developed the LegacyX framework.
...
- Utilized the LegacyX framework in the public sector.
- Focuses on enterprise software modernization.
...
- A global leading strategy consultancy.
- Uses an internal AI named 'Lilli'.
...
- Developer of the LegacyX framework.
