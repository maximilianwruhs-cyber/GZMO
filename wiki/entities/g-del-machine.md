...
- Assumes utility is measured by evaluation on tasks.
- Assumes repeatable trials for evaluation.
- Assumes prover has full knowledge of the utility function.
- Excludes evaluation actions from the action space.
- Assumes prover does not consume budget.
- Self-modifications consume exactly one budget unit.
