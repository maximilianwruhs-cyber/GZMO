...
- An event bus used for state synchronization.
- Associated with the Code Injection Manager.
...
- An event bus used for state synchronization.
- Part of the Code Injection Manager's functionality.
...
- An event bus used to maintain state synchronization.
