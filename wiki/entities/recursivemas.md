...
- Relies on 'Open-Weights' models.
- Uses RecursiveLink adapters.
- Has Sequential-Style and Mixture-Style topologies.
- Requires a CUDA-enabled graphics card for local execution.
- Features 'Backbone Model Sharing' for efficiency.
- Can be cloned from GitHub repository.
- Main script is run.py.
- RecursiveLink modules are defined in modeling.py.
- load_from_repo.py and hf_resolver.py handle MAS style to HuggingFace checkpoint mapping and download.
