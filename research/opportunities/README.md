...
| [felt-use-mass-growth](felt-use-mass-growth.md) | 22 | candidate (parked) | Felt Use mass growth (share_ge3_of_latest) — parked under disposable-vault |
...
| [promote-loop-ops-discovery](promote-loop-ops-discovery.md) | 20 | candidate | Promote-loop living apply for ops + discovery (after cognition soak) |
