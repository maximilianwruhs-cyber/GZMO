...
| 6 | `learning-loop-A` | Close Phase A learning loop (highest impact / lowest risk per research) | `75eb5004`, `6eaf665f`; tinyfolder product | **deepening** — `phase_a_proof` + `phase_a_ring` + `--aged-vault` 14,90 path; organic data-next aging still open | 9 | 5 | 6 | deepen dream/spark wiring (not new organ) |
