...
> **Shipped lab siblings (2026-07-20):** `forget-lint` · `verify-gates` · `token-economy` · `tool-chain` · `trace-memory` (LTL `--frontier`). Next archaeology pick: `learning-loop-A` (#6) — deepen dream/spark wiring, not a new organ.
