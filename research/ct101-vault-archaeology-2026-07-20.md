...
| 6 | `learning-loop-A` | Close Phase A learning loop (highest impact / lowest risk per research) | `75eb5004`, `6eaf665f`; tinyfolder product | **deepening** — vault spark window + [LEARNING_LOOP_A.md](../docs/LEARNING_LOOP_A.md); promote-back still open | 9 | 5 | 6 | deepen dream/spark wiring (not new organ) |
