...
| 6 | `learning-loop-A` | Close Phase A learning loop (highest impact / lowest risk per research) | `75eb5004`, `6eaf665f`; tinyfolder product | **deepening** — spark window + `vault-promote-spark` + handoff `--promote`; live promote proof still open | 9 | 5 | 6 | deepen dream/spark wiring (not new organ) |
