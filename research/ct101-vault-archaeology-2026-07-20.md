...
| 6 | `learning-loop-A` | Close Phase A learning loop (highest impact / lowest risk per research) | `75eb5004`, `6eaf665f`; tinyfolder product | **deepening** — proof + ring + `--aged-vault` + vault-maturity census; organic band thickening | 9 | 5 | 6 | deepen dream/spark wiring (not new organ) |
