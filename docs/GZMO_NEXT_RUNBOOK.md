...
bash scripts/promote-loop-soak-check.sh # overnight soak receipt for living-apply Done when #4
...
gzmo init --refresh-engine              # non-destructive [engine] rescan (prefer Prime :8000)
