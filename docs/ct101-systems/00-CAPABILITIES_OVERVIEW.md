...
| **Observability** | Synapse bus; `gzmo observatory` + OKForge `/observatory`; heartbeat checks | [synapse-writer](./80-synapse-bus/synapse-writer.md), [observatory](./110-external-nodes/observatory.md), [heartbeat-cheapcheck](./20-daemon-core/heartbeat-cheapcheck.md) |
