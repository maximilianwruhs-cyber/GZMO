...
> **Mode A is not scout KPI.** Forum-1 discover-only success criteria live in [DISCOVERY_LIFECYCLE.md](../../DISCOVERY_LIFECYCLE.md). Modes B/C below are **research theater** (lab pedagogy), not timer/publish health metrics.
...
Scaffold: `/opt/gzmo/current/.crew/{agents,teams,workflows}/`
